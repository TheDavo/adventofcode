...
with open(input_path) as input_file:
    # get first line and change to int
    bingo_calls = [int(x) for x in input_file.readline().strip().split(',')]
    ...
    for line in input_file:
        if line != '\n':
            # use int(x), False to help indicate marked value
...
# print('The solution to Day 1 Problem 4 is {}'.format(sol_1))
print('The solution to Day 1 Problem 4 is {}'.format(sol_2))
