...
def solve_part_one(input_path) -> int:
    """
        The school of lanternfish have a -respawn_rate- of 7 days.
        Newly born fish can spawn offspring in 9 days.

        Every passing day, the counter to a new fish spawning drops
         until the spawn time is 0.
...
def solve_part_two(input_path):
    """
        ...
        Storing how many of the fish spawn rates in dictionary/list as
         a fish counter will ease up memory limits.
    """
    lanternfish_spawn_time = get_init_fish(input_path)
    num_days = 256
